var Model = function(){
    ...
    var ListCargos = function(){
        table = $("#tblCargo").dataTable({
            ...
            "bServerSide" : true,
            "bAutoWidth": false,
            "ajax" : {type:'POST',url:"list_tipoproducto",data:function(d){d.desc = $("#txtDesc").val();}},
            "aoColumnDefs": [
            ...
            success:function(respJson){
                if(respJson!==null){
                    ...
                    for(var i=0;i<lista.length;i++){
                        ...
                        var valOb = lista[i].obligatorio;
                        var checkOb = (lista[i].obligatorio === "1") ? "checked" : "";
                        html+="<tr>";
                        html+="<td class='text-center'>"+(i+1)+"</td>";
                        html+="<td>"+lista[i].propiedad.nombre+"</td>";
                        html+="<td style='padding-bottom: 3px!important;padding-top: 4px!important;'>" + "<div class='i-checks text-center'><label class=\"text-center\"><input type=\"checkbox\" name=\"chkOpe\" id='chk_act_"+i+"' class=\"icheck chkGeneral\" value='"+val+"' "+check+" data-pos='"+i+"' data-ob='"+valOb+"' data-id='"+lista[i].id+"' data-checkbox=\"icheckbox_flat-blue\"/><span></span></label></div>" + "</td>";
                        html+="<td style='padding-bottom: 3px!important;padding-top: 4px!important;'>" + "<div class='i-checks text-center'><label class=\"text-center\"><input type=\"checkbox\" name=\"chkOb\" id='chk_ob_"+i+"' class=\"icheck chkObligatorio\" value='"+valOb+"' "+checkOb+" data-pos='"+i+"' data-id='"+lista[i].id+"' data-checkbox=\"icheckbox_flat-blue\"/><span></span></label></div>" + "</td>";
                        html+="</tr>";
                    }
                    ...
                    $('.chkObligatorio').iCheck({checkboxClass:'icheckbox_square-green'}).on('ifChanged',function(event){
                        checkObligatorio(event,$(this));
                    });
